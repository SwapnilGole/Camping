$(document).ready(() => {
  ...
  //       day = "0" + day.toString();
  //     }
  //     const maxDate = year + "-" + getMonth + "-" + day;
  //     $(".new-date").attr("min", maxDate);
  //   });
});
...
//     document
//       .getElementsByClassName("tab-content")[0]
//       .getElementsByClassName("tab-body")[0]
...
// collapse-expand time-schedule days wise
const colExBtn = document.querySelector(".col-ex-one");
const colExpContent = document.querySelector(".col-exp-one");
const colExBtnT = document.querySelector(".col-ex-two");
const colExpContentT = document.querySelector(".col-exp-two");

colExBtn.addEventListener("click", () => {
  colExpContent.classList.toggle("collapse-me");
  console.log(colExpContent);
});
colExBtnT.addEventListener("click", () => {
  colExpContentT.classList.toggle("collapse-me");
  console.log(colExpContentT);
});

// newDate Contact form
function dateFunct() {
  const todayDate = new Date();
  const getMonth = todayDate.getMonth() + 1;
  ...
  const maxDate = year + "-" + getMonth + "-" + day;
  document.querySelector(".new-date").setAttribute("min", maxDate);
}
dateFunct();
